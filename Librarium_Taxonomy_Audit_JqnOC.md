...
This is a read-only audit of the active JqnOC SQLite database at `%APPDATA%/Librarium/jqnoc.db`. The database was not modified. The audit includes every book with at least one populated value in `genres`, `subgenres`, `forms`, `themes`, `settings`, `historical_periods`, `subjects`, or `audiences`, and excludes only books with all eight fields empty.

- Included books: **445**
- Total books in the database: **719**
- Excluded books with no populated classification: **274**
- Sparse legacy records with values only in `themes`: **412**
- Richer records with at least one non-theme classification field: **33**
- Books requiring at least one manual confirmation: **24**
- Valid major Genre present in the current `genres` field: **33**
- Books already having exactly one valid Genre token and no extra Genre tokens: **4**

## Population

| Field | Books with a value |
| --- | ---: |
| Genres | 33 |
| Subgenres | 33 |
| Forms | 0 |
...
The most significant structural issue is that all 445 included books have values in `themes`, but `forms` is empty for every included book. The 412 sparse records therefore require at least a Genre correction, while the richer records need field-by-field cleanup and Form review.
...
- Treat ambiguous or comma-packed values as manual review items. No uncertain value is silently assigned to a new category.

## Global Findings

- Move or normalize genre-level legacy values from Themes: **315** token occurrences across the audit.
- Move non-genre values out of the Genre field: **185** token occurrences identified.
- Move or remove concrete values duplicated or misplaced in Themes: **63** token occurrences identified.
- Add or infer controlled Forms: **13** occurrences identified, with additional manual Form checks called out per record.
- Records containing a comma-packed or otherwise ambiguous legacy payload: **25** review groups identified.

The guide contains one controlled-vocabulary inconsistency: the `Reina del grito` example says `Essays`, while the Form rules require the singular controlled value `Essay`. This audit uses `Essay`.

## Book-by-Book Audit

Each entry preserves the exact populated database values first, followed by required corrections. `Manual review` means the stored data is insufficient to make a defensible automatic decision; it is not a database write.
...
- Current populated fields:
  - Genres: Fiction
  - Subgenres: British Literature; Coming-of-Age; Historical Fiction; Picaresque Fiction; Satirical Fiction
  - Themes: Belonging; Courage; Credulity; Deception; Depression; Faith; Freedom; Grief; Hope; Identity; Justice; Marginalization; Oppression; Perseverance; Resilience; Self-Discovery; Social Class; Survival; Womanhood
...
- Verdict: **Manual correction required**
- Required corrections:
  - Retain as Themes after removing misplaced values: Belonging; Courage; Credulity; Deception; Depression; Faith; Freedom; Grief; Hope; Identity; Justice; Marginalization; Oppression; Perseverance; Resilience; Self-Discovery; Social Class; Survival; Womanhood
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  ...
  - Subgenres: Urban History; Local History; Popular History; Short-form History; Accessible History
  - Themes: Dublin; Ireland; Irish history; Prehistory; Viking settlement; Medieval Dublin; British colonialism; Colonial Ireland; Georgian architecture; City biography; Urban development; Poverty and disease; Irish identity; Capital city; Population growth; Traffic and urban problems; Housing; Georgian beauty; Irish wit and culture; Irish literature; Leinster; Short-form history; Accessible history; Irish writer; Mercier Press; City portrait; Tragedy and resilience; Eras of glory; Hinterland and landscape; Affectionate tone; Politics; Society; Culture; Trade; Religion; Architecture; Colonialism; National Identity
  - Settings: Dublin; Ireland; Leinster
  - Historical Periods: Prehistory; Medieval; Early Modern; Modern; Contemporary; Viking Age; Georgian Era
  - Subjects: Irish History; Dublin History; Urban History; Cultural History; Irish Studies; British Colonialism; Colonial Ireland; Viking Settlement; Medieval Dublin; Georgian Architecture; Irish Literature; Geography; Capital Cities
  - Audiences: Adult; General Readers
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `History` -> Subgenres: `History`
  - Remove duplicate Themes value `Dublin`; retain Settings: `Dublin`
  - Remove duplicate Themes value `Ireland`; retain Settings: `Ireland`
  - Remove duplicate Themes value `Irish history`; retain Subjects: `Irish History`
  - Remove duplicate Themes value `Prehistory`; retain Historical Periods: `Prehistory`
  - Remove duplicate Themes value `Viking settlement`; retain Subjects: `Viking Settlement`
  - Remove duplicate Themes value `Medieval Dublin`; retain Subjects: `Medieval Dublin`
  - Remove duplicate Themes value `British colonialism`; retain Subjects: `British Colonialism`
  - Remove duplicate Themes value `Colonial Ireland`; retain Subjects: `Colonial Ireland`
  - Remove duplicate Themes value `Georgian architecture`; retain Subjects: `Georgian Architecture`
  - Remove duplicate Themes value `Irish literature`; retain Subjects: `Irish Literature`
  - Remove duplicate Themes value `Leinster`; retain Settings: `Leinster`
  - Remove duplicate Themes value `Short-form history`; retain Subgenres: `Short-form History`
  - Remove duplicate Themes value `Accessible history`; retain Subgenres: `Accessible History`
  - Move Themes: `Politics` -> Subjects: `Politics`
  - Move Themes: `Trade` -> Subjects: `Trade`
  - Move Themes: `Religion` -> Subgenres: `Religion`
  - Move Themes: `Colonialism` -> Subjects: `Colonialism`
  - Retain as Themes after removing misplaced values: City biography; Urban development; Poverty and disease; Irish identity; Capital city; Population growth; Traffic and urban problems; Housing; Georgian beauty; Irish wit and culture; Irish writer; Mercier Press; City portrait; Tragedy and resilience; Eras of glory; Hinterland and landscape; Affectionate tone; Society; Culture; Architecture; National Identity
...
- Current populated fields:
  ...
  - Subgenres: Feminist Fiction; Novella; Political Fiction; Psychological Fiction; Tragic Fiction
  - Themes: Class; Death; Disillusionment; Drowning; Fear; Feminist Critique; Gender; Hero Worship; Identity; Loneliness; Male Privilege; Manipulation; Memory; Moral Ambiguity; Mortality; Patriarchy; Power; Power Imbalance; Sexual Politics; Silence; Social Class; Survival; Trauma; Vulnerability
...
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `Literary Fiction` -> Subgenres: `Literary Fiction`
  - Move Subgenres: `Novella` -> Forms: `Novella`
  - Remove duplicate Themes value `Drowning`; retain Subjects: `Drowning`
  - Retain as Themes after removing misplaced values: Class; Death; Disillusionment; Fear; Feminist Critique; Gender; Hero Worship; Identity; Loneliness; Male Privilege; Manipulation; Memory; Moral Ambiguity; Mortality; Patriarchy; Power; Power Imbalance; Sexual Politics; Silence; Social Class; Survival; Trauma; Vulnerability
  - Populate Forms with: Novella
...
- Current populated fields:
  ...
  - Subgenres: Historical Biography; Historical Essay; Intellectual History; Popular History
...
- Verdict: **Manual correction required**
- Required corrections:
  - Keep only Genres: `Biography`; remove the mutually exclusive major labels Non-Fiction
  - Move Genres: `History` -> Subgenres: `History`
  - Retain as Themes after removing misplaced values: Chance; Discovery; Exploration; Fame; Historical Error; Historical Interpretation; Historical Memory; Identity; Irony of History; Justice; Legacy; Merit; Reputation; Truth
- Manual review:
  - Confirm the proposed major Genre when the record contains more than one allowed major value
...
- Current populated fields:
  ...
  - Subgenres: Essay; Film Diary; Film History; Film Studies; German-Language Literature; Literary Non-Fiction; Production Diary; Travel Writing
  - Themes: Adventure; Ambition; Art and Sacrifice; Artistic Creation; Creative Process; Creativity; Exploration; Failure; Filmmaking; Human Will; Isolation; Madness; Man versus Nature; Nature; Nature as Hostile Force; Obsession; Perseverance; Philosophical Reflection; Reality and Illusion; Risk; Survival; The Impossible
...
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `Memoir` -> Subgenres: `Memoir`
  - Move Subgenres: `Essay` -> Forms: `Essay`
  - Move Subgenres: `Film Diary` -> Forms: `Diary`
  - Move Subgenres: `Production Diary` -> Forms: `Diary`
  - Remove duplicate Themes value `Creative Process`; retain Subjects: `Creative Process`
  - Remove duplicate Themes value `Filmmaking`; retain Subjects: `Filmmaking`
  - Move Themes: `Adventure` -> Subgenres: `Adventure Fiction`
  - Retain as Themes after removing misplaced values: Ambition; Art and Sacrifice; Artistic Creation; Creativity; Exploration; Failure; Human Will; Isolation; Madness; Man versus Nature; Nature; Nature as Hostile Force; Obsession; Perseverance; Philosophical Reflection; Reality and Illusion; Risk; Survival; The Impossible
  - Populate Forms with: Essay; Diary

#### 6. Conversaciones con Akira Kurosawa - Akira Kurosawa

- Database ID: `2ee8b013-0102-4917-84b4-f6fedc168c94`
- Current populated fields:
  - Genres: Film Studies; Non-Fiction
  - Subgenres: Biography; Cinema History; Film Criticism; Interview Collection; Japanese Cinema
  - Themes: Art and Silence; Artistic Creation; Artistic Integrity; Artistic Vision; Collaboration; Creativity; Filmmaking; Human Nature; Humanism; Inspiration; Memory; Perfectionism; Silence; Storytelling; Tradition and Modernity
  - Settings: Japan; Tokyo
  - Historical Periods: 1960s; 20th Century; Postwar Japan
  - Subjects: 20th-Century Japanese Culture; Adaptation; Akira Kurosawa; Auteur Theory; Cinema; Cinema History; Dersu Uzala; Donald Richie; Film Criticism; Film Direction; Film History; Film Production; Film Studies; Gabriel García Márquez; George Lucas; Hollywood; Humanism; Japanese Cinema; Japanese Culture; Japanese Film Industry; Kagemusha; Kenji Mizoguchi; Nagisa Oshima; Ran; Rashomon; Screenwriting; Seven Samurai; Steven Spielberg; Yasujirō Ozu
  - Audiences: Adult; General Readers
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `Film Studies` -> Subgenres: `Film Studies`
  - Remove duplicate Subgenres value `Biography`; retain Biography only as the major Genre when appropriate
  - Move Subgenres: `Interview Collection` -> Forms: `Interview`
  - Remove duplicate Themes value `Humanism`; retain Subjects: `Humanism`
  - Move Themes: `Filmmaking` -> Subjects: `Filmmaking`
  - Retain as Themes after removing misplaced values: Art and Silence; Artistic Creation; Artistic Integrity; Artistic Vision; Collaboration; Creativity; Human Nature; Inspiration; Memory; Perfectionism; Silence; Storytelling; Tradition and Modernity
  - Populate Forms with: Interview
...
- Current populated fields:
  - Genres: Non-Fiction; History
  - Subgenres: Cultural History; Environmental History; Popular History; Popular Science; Nature Writing; Essay
  - Themes: Winter; Nature; Seasonal Change; Human Adaptation; Survival; Cultural Memory; Tradition; Landscape; Science; Curiosity; Imagination; Nostalgia; Community; Solidarity; Resilience
  - Settings: Europe; Alps; Arctic; North America
  - Historical Periods: Ice Age; Medieval; Little Ice Age; Early Modern; Modern; Contemporary
  - Subjects: Environmental History; Cultural History; Climate History; Winter; Seasons; Climate Change; Meteorology; Cryosphere; Snow; Ice; Snowflakes; Freezing; Alpine History; Arctic Exploration; Winter Sports; Ice Skating; Ice Trade; Folklore; Winter Mythology; Art History; History of Science; Literature; Animal Adaptation; Plant Adaptation; White Christmas; Year Without a Summer; World Ice Theory; Wilson Bentley
  - Audiences: Adult; General Readers
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `History` -> Subgenres: `History`
  - Move Subgenres: `Essay` -> Forms: `Essay`
  - Remove duplicate Themes value `Winter`; retain Subjects: `Winter`
  - Move Themes: `Science` -> Subgenres: `Science`
  - Retain as Themes after removing misplaced values: Nature; Seasonal Change; Human Adaptation; Survival; Cultural Memory; Tradition; Landscape; Curiosity; Imagination; Nostalgia; Community; Solidarity; Resilience
  - Populate Forms with: Essay

#### 8. Descripción de China - Matteo Ricci

- Database ID: `59ff6882-c024-4b16-b969-069cdfce81dc`
- Current populated fields:
  - Genres: Non-Fiction; History; Travel Writing
  - Subgenres: Historical Non-Fiction; Historical Narrative; Cultural History; Religious History; Ethnography; Sinology; Asian Studies
  - Themes: Cultural Exchange; Cross-Cultural Dialogue; Cultural Understanding; Cultural Accommodation; Inculturation; Exploration; Curiosity; Knowledge; Religion; Evangelization; Diplomacy; Identity; Tolerance; Civilization; Education; Science
  - Settings: China; Ming China; Beijing; Nanjing; Macau
  - Historical Periods: Early Modern; Late Ming Dynasty; Late 16th Century; Early 17th Century
  - Subjects: Chinese History; History of China; Chinese Culture; Sinology; Asian Studies; Ming Dynasty; Confucianism; Chinese Philosophy; Buddhism; Taoism; Christianity in China; Catholic Church; Jesuits; Society of Jesus; Catholic Missions; Counter-Reformation; Cultural Exchange; Ethnography; Geography; Cartography; World Map in Chinese; Western Science in China; Chinese Government; Imperial Court; Mandarins; Europe's Image of China; Primary Historical Sources
  - Audiences: Adult; General Readers
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `History` -> Subgenres: `History`
  - Move Genres: `Travel Writing` -> Subgenres: `Travel Writing`
  - Remove duplicate Themes value `Cultural Exchange`; retain Subjects: `Cultural Exchange`
  - Move Themes: `Religion` -> Subgenres: `Religion`
  - Move Themes: `Science` -> Subgenres: `Science`
  - Retain as Themes after removing misplaced values: Cross-Cultural Dialogue; Cultural Understanding; Cultural Accommodation; Inculturation; Exploration; Curiosity; Knowledge; Evangelization; Diplomacy; Identity; Tolerance; Civilization; Education
...
- Verdict: **Manual correction required**
- Required corrections:
  - Retain as Themes after removing misplaced values: Ambition; Belonging; Community; Conflict; Cooperation; Division; Faith; Family; Freedom; Hope; Identity; Innovation; Justice; Leadership; Legacy; Love; Patriarchy; Perseverance; Power; Revenge; Sacrifice; Social Hierarchy; Spirituality; Survival; Tradition; Vision
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  - Genres: Non-Fiction; History
  - Subgenres: Maritime History; Industrial History; Architectural History; Local History; Academic Non-Fiction
  - Themes: Heritage Conservation; Industrialization; Technological Innovation; Maritime Engineering; Infrastructure; Restoration; Economic Development; Urban Development; Cultural Heritage
  - Settings: Santander; Bay of Santander; Cantabria; Spain
  - Historical Periods: Industrial Revolution; Modern; Contemporary; Late 19th Century; Early 20th Century; Restoration Spain
  - Subjects: Industrial Heritage; Maritime History; Spanish Naval History; Naval Engineering; Port Engineering; Maritime Infrastructure; Dry Docks; Shipbuilding; Ship Repair; Merchant Shipping; Fishing Industry; Port Infrastructure; Port of Santander; Dique de Gamazo; Junta de Obras del Puerto; Cantabrian History; Spanish Industrialization; Industrial Archaeology; Engineering History; Civil Engineering; Hydraulic Engineering; Restoration Architecture; Bien de Interés Cultural; Heritage Conservation
  - Audiences: Adult; General Readers
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `History` -> Subgenres: `History`
  - Remove duplicate Themes value `Heritage Conservation`; retain Subjects: `Heritage Conservation`
  - Retain as Themes after removing misplaced values: Industrialization; Technological Innovation; Maritime Engineering; Infrastructure; Restoration; Economic Development; Urban Development; Cultural Heritage

#### 11. El emblema del traidor - Juan Gómez-Jurado

- Database ID: `24224bef-81d5-4689-84b9-312e0b7f2a5c`
- Current populated fields:
  - Genres: Fiction; Historical Fiction; Thriller; Adventure Fiction
  - Subgenres: Historical Thriller; Espionage Fiction; Political Fiction; Mystery; Historical Romance; Coming-of-Age
  - Themes: Identity; Search for Truth; Betrayal; Loyalty; Revenge; Justice; Family Secrets; Family Rivalry; Love; Forbidden Love; Anti-Semitism; Political Intrigue; Pursuit; Persecution; Survival; Sacrifice; Courage; Totalitarianism; Truth and Its Consequences; Orphan Protagonist
  - Settings: Germany; Munich; Berlin; Strait of Gibraltar; Europe
  - Historical Periods: Modern; Interwar Period; World War II; Nazi Germany; 1940s
  - Subjects: German History; World War II; Nazism; Holocaust; Political History; Espionage; Intelligence Services; Resistance Movements; Freemasonry; Secret Societies; Spanish Literature
  - Audiences: Adult; General Readers
- Verdict: **Manual correction required**
- Required corrections:
  - Move Genres: `Historical Fiction` -> Subgenres: `Historical Fiction`
  - Move Genres: `Thriller` -> Subgenres: `Thriller`
  - Move Genres: `Adventure Fiction` -> Subgenres: `Adventure Fiction`
  - Retain as Themes after removing misplaced values: Identity; Search for Truth; Betrayal; Loyalty; Revenge; Justice; Family Secrets; Family Rivalry; Love; Forbidden Love; Anti-Semitism; Political Intrigue; Pursuit; Persecution; Survival; Sacrifice; Courage; Totalitarianism; Truth and Its Consequences; Orphan Protagonist
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  - Genres: Fiction; Literary Fiction
  - Subgenres: Philosophical Fiction; Existential Fiction; Psychological Fiction; Absurdist Fiction
  - Themes: Alienation; Absurdity; Existentialism; Meaninglessness; The Human Condition; Death; Mortality; Freedom; Responsibility; Indifference; Emotional Detachment; Grief; Isolation; Identity; Authenticity; Moral Ambiguity; Justice; Guilt; Social Conformity; Outsider; Colonialism; Murder; Atheism
  - Settings: Algiers; French Algeria; Algeria; Mediterranean
  - Historical Periods: Modern; Interwar Period; 1940s
  - Subjects: Albert Camus; French Literature; Philosophy; Existentialism; Absurdism; Colonialism; French Colonialism; French Algeria; Capital Punishment; Criminal Justice; Murder; The Arab; First-Person Narration
  - Audiences: Adult; General Readers
- Verdict: **Manual correction required**
- Required corrections:
  - Move Genres: `Literary Fiction` -> Subgenres: `Literary Fiction`
  - Remove duplicate Themes value `Existentialism`; retain Subjects: `Existentialism`
  - Remove duplicate Themes value `Colonialism`; retain Subjects: `Colonialism`
  - Remove duplicate Themes value `Murder`; retain Subjects: `Murder`
  - Retain as Themes after removing misplaced values: Alienation; Absurdity; Meaninglessness; The Human Condition; Death; Mortality; Freedom; Responsibility; Indifference; Emotional Detachment; Grief; Isolation; Identity; Authenticity; Moral Ambiguity; Justice; Guilt; Social Conformity; Outsider; Atheism
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  ...
  - Subgenres: Philosophical Essay; Existential Philosophy
  - Themes: The Absurd; Meaning of Life; Meaninglessness; Suicide; Revolt; Freedom; Passion; Death; Mortality; Consciousness; Hope; Despair; Authenticity; Individualism; Alienation; Atheism; Reason versus Irrationality; The Human Condition
  - Historical Periods: 20th Century
  - Subjects: Philosophy; French Philosophy; French Literature; Existentialism; Absurdism; Absurdist Philosophy; Ethics; Greek Mythology; Sisyphus; Suicide; Literature and Philosophy; 20th-Century Philosophy; Friedrich Nietzsche; Søren Kierkegaard; Fyodor Dostoevsky
  - Audiences: Adult
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `Philosophy` -> Subgenres: `Philosophy`
  - Remove duplicate Themes value `Suicide`; retain Subjects: `Suicide`
  - Move Themes: `Consciousness` -> Subjects: `Consciousness`
  - Retain as Themes after removing misplaced values: The Absurd; Meaning of Life; Meaninglessness; Revolt; Freedom; Passion; Death; Mortality; Hope; Despair; Authenticity; Individualism; Alienation; Atheism; Reason versus Irrationality; The Human Condition
...
- Current populated fields:
  ...
  - Subgenres: Historical Mystery; Historical Romance; Costumbrista Fiction
  - Themes: Love; Love Triangle; First Love; Forbidden Love; Secrets; Lies; Identity; Origins; Ambition; Corruption; Loyalty; Betrayal; Social Class; Aristocracy; Serving Class; Women's Lives; Crime; Diamond Trafficking; Water Symbolism
  - Settings: Balneario de Mondariz; Mondariz; Galicia; Spain
  - Historical Periods: Modern; Interwar Period; 1920s
  - Subjects: Spanish History; Galician History; Spa Culture; Thermal Baths; Galician Landscape; Social History
  - Audiences: Adult; General Readers
- Verdict: **Manual correction required**
- Required corrections:
  - Move Genres: `Historical Fiction` -> Subgenres: `Historical Fiction`
  - Move Genres: `Romance` -> Subgenres: `Romance`
  - Move Genres: `Thriller` -> Subgenres: `Thriller`
  - Move Themes: `Women's Lives` -> Subjects: `Women's Lives`
  - Move Themes: `Crime` -> Subjects: `Crime`
  - Retain as Themes after removing misplaced values: Love; Love Triangle; First Love; Forbidden Love; Secrets; Lies; Identity; Origins; Ambition; Corruption; Loyalty; Betrayal; Social Class; Aristocracy; Serving Class; Diamond Trafficking; Water Symbolism
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  ...
  - Subgenres: Historical Biography; Royal Biography; Political History
  - Themes: Power; Monarchy; Leadership; Empire; Religion; Diplomacy; War; Political Strategy; Duty; Faith; Kingship; Court Life; Centralization of Power; Religious Reform; Arts Patronage; Cultural Transformation; Regional Tensions; State Finances
  - Settings: Spain; Madrid; El Escorial; Portugal; Spanish Netherlands; Europe; Americas
  - Historical Periods: Early Modern; Renaissance; Spanish Golden Age; 16th Century
  - Subjects: Philip II of Spain; Spanish History; Early Modern History; European History; Habsburg Dynasty; Spanish Empire; Atlantic Empire; Absolute Monarchy; Counter-Reformation; Catholic Church; European Diplomacy; Colonization of the Americas; Battle of Lepanto; Spanish Armada; Annexation of Portugal; Morisco Rebellion; Prince Don Carlos; El Escorial; Spanish Historiography; Mary I of England; Charles V Holy Roman Emperor
  - Audiences: Adult; General Readers
- Verdict: **Manual correction required**
- Required corrections:
  - Keep only Genres: `Biography`; remove the mutually exclusive major labels Non-Fiction
  - Move Genres: `History` -> Subgenres: `History`
  - Move Themes: `Religion` -> Subgenres: `Religion`
  - Retain as Themes after removing misplaced values: Power; Monarchy; Leadership; Empire; Diplomacy; War; Political Strategy; Duty; Faith; Kingship; Court Life; Centralization of Power; Religious Reform; Arts Patronage; Cultural Transformation; Regional Tensions; State Finances
- Manual review:
  - Confirm the proposed major Genre when the record contains more than one allowed major value
...
- Current populated fields:
  ...
  - Subgenres: Literary Science Fiction; Psychological Fiction; Philosophical Fiction; Epistolary Novel; Speculative Fiction; Social Commentary; Tragedy; Coming-of-Age
  - Themes: Identity; Memory; Self-Awareness; Consciousness; Intelligence; Knowledge; Human Dignity; Friendship; Love; Romantic Relationships; Loneliness; Isolation; Alienation; Acceptance; Discrimination; Empathy; Loss of Innocence; Cognitive Decline; Psychological Transformation; Happiness; Ethics; Medical Ethics; Scientific Ethics; Human Experimentation; Hubris; Free Will; Mortality; Hope; The Cost of Progress
  - Settings: New York City; New York; United States
  - Historical Periods: Contemporary; Mid-20th Century; 1960s
  - Subjects: American Literature; Science Fiction; Psychology; Neuroscience; Cognitive Enhancement; Intellectual Disability; Experimental Medicine; Medical Ethics; Scientific Ethics; Consciousness; Mouse Symbolism
  - Audiences: Adult; Young Adult
- Verdict: **Manual correction required**
- Required corrections:
  - Keep only Genres: `Science Fiction`; remove the mutually exclusive major labels Fiction
  - Add Forms: `Novel` based on Subgenres: `Epistolary Novel`
  - Remove duplicate Themes value `Consciousness`; retain Subjects: `Consciousness`
  - Remove duplicate Themes value `Medical Ethics`; retain Subjects: `Medical Ethics`
  - Remove duplicate Themes value `Scientific Ethics`; retain Subjects: `Scientific Ethics`
  - Move Themes: `Ethics` -> Subjects: `Ethics`
  - Retain as Themes after removing misplaced values: Identity; Memory; Self-Awareness; Intelligence; Knowledge; Human Dignity; Friendship; Love; Romantic Relationships; Loneliness; Isolation; Alienation; Acceptance; Discrimination; Empathy; Loss of Innocence; Cognitive Decline; Psychological Transformation; Happiness; Human Experimentation; Hubris; Free Will; Mortality; Hope; The Cost of Progress
  - Populate Forms with: Novel
- Manual review:
  - Confirm the proposed major Genre when the record contains more than one allowed major value
...
- Current populated fields:
  - Genres: Fiction; Horror; Historical Fiction; Thriller
  - Subgenres: Gothic Fiction; Historical Thriller; Penny Dreadful; Psychological Horror
  - Themes: Revenge; Good versus Evil; Murder; Serial Murder; Greed; Family; Inheritance; Social Class; Poverty; Female Power; Female Villain; Female Protagonist; Identity; Survival; Psychic Powers; Clairvoyance; Cat and Mouse; Gore; Violence; Justice
  - Settings: New York City; New York; United States
  - Historical Periods: Modern; Victorian Era; Gilded Age; 1860s
  - Subjects: American Literature; Gothic Fiction; Serial Killers; Murder; Clairvoyance; Psychic Phenomena; Family Violence; New York City; Victorian America
  - Audiences: Adult
- Verdict: **Manual correction required**
- Required corrections:
  - Move Genres: `Horror` -> Subgenres: `Horror`
  - Move Genres: `Historical Fiction` -> Subgenres: `Historical Fiction`
  - Move Genres: `Thriller` -> Subgenres: `Thriller`
  - Remove duplicate Themes value `Murder`; retain Subjects: `Murder`
  - Remove duplicate Themes value `Clairvoyance`; retain Subjects: `Clairvoyance`
  - Move Themes: `Violence` -> Subjects: `Violence`
  - Retain as Themes after removing misplaced values: Revenge; Good versus Evil; Serial Murder; Greed; Family; Inheritance; Social Class; Poverty; Female Power; Female Villain; Female Protagonist; Identity; Survival; Psychic Powers; Cat and Mouse; Gore; Justice
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  ...
  - Subgenres: Historical Mystery; Historical Romance; Family Saga; Costumbrista Fiction
  - Themes: Family Secrets; Family Mystery; Love; Impossible Love; Social Class; Class Differences; Aristocracy; Women's Lives; Women's Work; Female Artisans; Female Resilience; Identity; Heritage; Artisanship; Prejudice; Domestic Abuse; Ambition; Envy; Multi-Generational Saga; Three Generations of Women
  - Settings: Seville; Triana; Andalusia; Spain
  - Historical Periods: Modern; 19th Century; Early 20th Century; Belle Époque
  - Subjects: Spanish History; Ceramics; Pottery; Decorative Arts; Andalusian Culture; La Cartuja Porcelain Factory; Pickman Family; Sevillian Society
  - Audiences: Adult; General Readers
- Verdict: **Manual correction required**
- Required corrections:
  - Move Genres: `Historical Fiction` -> Subgenres: `Historical Fiction`
  - Move Genres: `Romance` -> Subgenres: `Romance`
  - Move Themes: `Women's Lives` -> Subjects: `Women's Lives`
  - Retain as Themes after removing misplaced values: Family Secrets; Family Mystery; Love; Impossible Love; Social Class; Class Differences; Aristocracy; Women's Work; Female Artisans; Female Resilience; Identity; Heritage; Artisanship; Prejudice; Domestic Abuse; Ambition; Envy; Multi-Generational Saga; Three Generations of Women
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  - Genres: Fiction; Historical Fiction; Adventure Fiction
  - Subgenres: Historical Adventure; Historical Thriller; Historical Mystery; Coming-of-Age; Picaresque
  - Themes: Identity; Coming of Age; Survival; Poverty; Social Class; Inequality; Justice; Injustice; Friendship; Loyalty; Betrayal; Revenge; Courage; Ambition; Freedom; Crime; Redemption; Love; Passion; Plague; Orphanhood; Class Struggle
  - Settings: Seville; Andalusia; Spain
  - Historical Periods: Early Modern; Renaissance; Spanish Golden Age; 16th Century
  - Subjects: Spanish History; Spanish Golden Age; Spanish Literature; Seville; Philip II of Spain; Spanish Empire; Social History; Maritime History; Crime; Organized Crime; Plague; Galley Slaves; Cervantes; William Shakespeare; Don Quixote
  - Audiences: Adult; General Readers
- Verdict: **Manual correction required**
- Required corrections:
  - Move Genres: `Historical Fiction` -> Subgenres: `Historical Fiction`
  - Move Genres: `Adventure Fiction` -> Subgenres: `Adventure Fiction`
  - Remove duplicate Themes value `Crime`; retain Subjects: `Crime`
  - Remove duplicate Themes value `Plague`; retain Subjects: `Plague`
  - Retain as Themes after removing misplaced values: Identity; Coming of Age; Survival; Poverty; Social Class; Inequality; Justice; Injustice; Friendship; Loyalty; Betrayal; Revenge; Courage; Ambition; Freedom; Redemption; Love; Passion; Orphanhood; Class Struggle
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  - Genres: Science Fiction; Speculative Fiction; Literary Fiction; Fiction
  - Subgenres: Feminist Science Fiction; Political Fiction; Social Science Fiction; Philosophical Fiction
  - Themes: Gender; Sexuality; Androgyny; Non-Binary Identity; Friendship; Loyalty; Otherness; Identity; Isolation; Duality; Political Intrigue; Exile; Cultural Observation; Outsider Perspective; Nationalism; Betrayal; Epic Journey; Social Structure
  - Settings: Fictional Planet; Alien World; Gethen; Winter
  - Historical Periods: Future
  - Subjects: Anthropology; Politics; Sociology; Gender Studies; Alien Culture; World-Building; First Contact; Ethnographic Narrative; Hainish Cycle; Taoism; Telepathy; Kemmer
  - Audiences: Adult
- Verdict: **Manual correction required**
- Required corrections:
  - Keep only Genres: `Science Fiction`; remove the mutually exclusive major labels Fiction
  - Move Genres: `Speculative Fiction` -> Subgenres: `Speculative Fiction`
  - Move Genres: `Literary Fiction` -> Subgenres: `Literary Fiction`
  - Retain as Themes after removing misplaced values: Gender; Sexuality; Androgyny; Non-Binary Identity; Friendship; Loyalty; Otherness; Identity; Isolation; Duality; Political Intrigue; Exile; Cultural Observation; Outsider Perspective; Nationalism; Betrayal; Epic Journey; Social Structure
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm the proposed major Genre when the record contains more than one allowed major value
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  - Genres: Fiction; Adventure Fiction; Fantasy
  - Subgenres: Classic Literature; Maritime Adventure; Mythological Fiction; Folklore
  - Themes: Adventure; Exploration; Courage; Survival; Perseverance; Curiosity; Fortune; Wealth; Greed; Wisdom; Storytelling; Oral Tradition; Hospitality; Justice; Wonder; Fate; Hero's Journey; Spirituality
  - Settings: Baghdad; Abbasid Caliphate; Indian Ocean; Persian Gulf; Arabian Sea; Madagascar; China; Exotic Lands
  - Historical Periods: Medieval; Islamic Golden Age; 9th Century
  - Subjects: Sinbad the Sailor; Arabic Literature; Medieval Literature; Middle Eastern Literature; Abbasid Caliphate; Medieval Islamic World; Maritime History; Navigation; Merchants and Trade; Mythology; Folklore; Mythical Creatures; Fantastic Beasts; Persian Origins; Seven Voyages; Frame Narrative
  - Audiences: Adult; General Readers
- Verdict: **Manual correction required**
- Required corrections:
  - Keep only Genres: `Fantasy`; remove the mutually exclusive major labels Fiction
  - Move Genres: `Adventure Fiction` -> Subgenres: `Adventure Fiction`
  - Move Themes: `Adventure` -> Subgenres: `Adventure Fiction`
  - Move Themes: `Oral Tradition` -> Subjects: `Oral Tradition`
  - Move Themes: `Hero's Journey` -> Subjects: `Hero's Journey`
  - Retain as Themes after removing misplaced values: Exploration; Courage; Survival; Perseverance; Curiosity; Fortune; Wealth; Greed; Wisdom; Storytelling; Hospitality; Justice; Wonder; Fate; Spirituality
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm the proposed major Genre when the record contains more than one allowed major value
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  - Genres: Fiction; Literary Fiction
  - Subgenres: Historical Fiction; Novella; Psychological Fiction; Short Fiction
...
- Required corrections:
  - Move Genres: `Literary Fiction` -> Subgenres: `Literary Fiction`
  - Move Subgenres: `Novella` -> Forms: `Novella`
  - Retain as Themes after removing misplaced values: Antisemitism; Bibliophilia; Books; Bureaucracy; Civilization; Cultural Memory; Displacement; Fragility of Culture; Friendship; Genius; Human Dignity; Identity; Injustice; Isolation; Knowledge; Loss; Love of Literature; Memory; Nostalgia; Obsession; Persecution; Reading; War
  - Populate Forms with: Novella
...
- Current populated fields:
  ...
  - Subgenres: Literary Memoir; Family Biography; Psychological Non-Fiction; Family Drama
  - Themes: Family; Motherhood; Mother-Daughter Relationship; Maternal Love; Memory; Childhood; Childhood Trauma; Family Secrets; Family Dysfunction; Silence; Repression; Identity; Mental Illness; Depression; Bipolar Disorder; Grief; Loss; Mourning; Trauma; Love; Resilience; Courage; Vulnerability; Appearance and Reality; Suicide; Child Sexual Abuse; Incest
  - Settings: France; Paris
  - Historical Periods: Contemporary; Late 20th Century; 1960s; 1970s
  - Subjects: Delphine de Vigan; Lucile Poirier; French Literature; Biography; Family History; Women's Lives; Mental Health; Psychiatry; Psychology; Oral History; Photography; Writing
  - Audiences: Adult; General Readers
- Verdict: **Manual correction required**
- Required corrections:
  - Keep only Genres: `Biography`; remove the mutually exclusive major labels Non-Fiction
  - Move Genres: `Memoir` -> Subgenres: `Memoir`
  - Move Subgenres: `Literary Memoir` -> Forms: `Memoir`
  - Move Themes: `Suicide` -> Subjects: `Suicide`
  - Retain as Themes after removing misplaced values: Family; Motherhood; Mother-Daughter Relationship; Maternal Love; Memory; Childhood; Childhood Trauma; Family Secrets; Family Dysfunction; Silence; Repression; Identity; Mental Illness; Depression; Bipolar Disorder; Grief; Loss; Mourning; Trauma; Love; Resilience; Courage; Vulnerability; Appearance and Reality; Child Sexual Abuse; Incest
  - Populate Forms with: Memoir
- Manual review:
  - Confirm the proposed major Genre when the record contains more than one allowed major value
...
- Current populated fields:
  ...
  - Subgenres: Autobiographical Essay; Cultural Criticism; Feminist Non-Fiction; Film Criticism; Genre Journalism; Personal Memoir; Spanish Film Criticism
...
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `Essay` -> Forms: `Essay`
  - Move Subgenres: `Personal Memoir` -> Forms: `Memoir`
  - Retain as Themes after removing misplaced values: Aging; Anxiety; Body Image; Catharsis; Desire; Fear; Fear and Fascination; Feminine Fears; Feminism; Identity; Memory; Motherhood; Patriarchy; Self-Exposure; Sexuality; Social Expectations; Social Pressure; Trauma; Womanhood
  - Populate Forms with: Essay; Memoir
...
- Current populated fields:
  - Genres: Fiction; Science Fiction
  - Subgenres: Hard Science Fiction; First Contact; Space Exploration; Big Dumb Object
  - Themes: Exploration; Discovery; Curiosity; Mystery; Wonder; Sense of Wonder; Scientific Inquiry; Humanity; Humanity's Insignificance; Isolation; Cooperation; Survival; The Unknown; Non-Communication; Cold Rationalism
  - Settings: Solar System; Rama; Space
  - Historical Periods: Future; Near Future
  - Subjects: Astronomy; Space Exploration; Extraterrestrial Intelligence; Alien Spacecraft; Interstellar Objects; Alien Technology; Artificial Worlds; Cylindrical Worlds; Engineering; Physics; Zero Gravity; Biots; Spacecraft; British Literature; Classic Literature
  - Audiences: Adult; General Readers
- Verdict: **Manual correction required**
- Required corrections:
  - Keep only Genres: `Science Fiction`; remove the mutually exclusive major labels Fiction
  - Move Themes: `Mystery` -> Subgenres: `Mystery`
  - Retain as Themes after removing misplaced values: Exploration; Discovery; Curiosity; Wonder; Sense of Wonder; Scientific Inquiry; Humanity; Humanity's Insignificance; Isolation; Cooperation; Survival; The Unknown; Non-Communication; Cold Rationalism
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm the proposed major Genre when the record contains more than one allowed major value
  - Confirm Form because the database does not store presentation mode for this record
...
- Verdict: **Manual correction required**
- Required corrections:
  - Remove duplicate Themes value `Mental Health`; retain Subjects: `Mental Health`
  - Retain as Themes after removing misplaced values: Addiction; Ambition; Betrayal; Compassion; Cooperation; Courage; Depression; Destiny; Discovery; Duty; Duty versus Desire; Faith; Family; Forgiveness; Freedom; Friendship; Grief; Healing; Honor; Hope; Identity; Innovation; Isolation; Justice; Knowledge; Leadership; Love; Loyalty; Moral Responsibility; Oppression; Parenthood; Perseverance; Power; Purpose; Reconciliation; Recovery; Redemption; Resilience; Responsibility; Sacrifice; Self-Acceptance; Survival; Tradition versus Modernity; Trauma; Trust; Unity
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  - Genres: Non-Fiction; History
  - Subgenres: Popular History; National History; Scottish Studies; Cultural History
  - Themes: National Identity; Cultural Identity; Nation Building; Political Change; Conflict; Independence; Union; Religion; Power; Heritage; Tradition and Modernity; Social Change; Landscape and Identity
  - Settings: Scotland; Great Britain; British Isles
  - Historical Periods: Prehistory; Ancient; Medieval; Early Modern; Modern; Contemporary
  - Subjects: Scottish History; Scottish Culture; Scotland; United Kingdom; British History; Prehistoric Britain; Ice Age Britain; Picts; Scots; Angles; Romans in Britain; Viking Age; Medieval Scotland; Wars of Scottish Independence; William Wallace; Robert the Bruce; Macbeth; House of Stuart; Scottish Reformation; Act of Union 1707; Jacobitism; Scottish Enlightenment; Highland Clearances; Industrial Revolution; 20th-Century Scotland; Devolution; Scottish Parliament; Celtic Culture
  - Audiences: Adult; General Readers
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `History` -> Subgenres: `History`
  - Move Themes: `Religion` -> Subgenres: `Religion`
  - Retain as Themes after removing misplaced values: National Identity; Cultural Identity; Nation Building; Political Change; Conflict; Independence; Union; Power; Heritage; Tradition and Modernity; Social Change; Landscape and Identity
...
- Current populated fields:
  ...
  - Subgenres: Introductory Guide; Comparative Religion
  - Themes: Spirituality; Nature; Ritual; Tradition; Purity; Community; Sacred Places; Festivals
  - Settings: Japan
  - Historical Periods: Contemporary
  - Subjects: Japanese Religion; Japanese Culture; Religious Studies; Mythology; Shinto
  - Audiences: Adult; General Readers
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `Religion` -> Subgenres: `Religion`
  - Retain as Themes after removing misplaced values: Spirituality; Nature; Ritual; Tradition; Purity; Community; Sacred Places; Festivals
...
- Current populated fields:
  - Genres: Fiction; Literary Fiction
  - Subgenres: Satirical Fiction; Philosophical Fiction; Modernist Literature; Japanese Literature; Classic Literature; Humour; Comedy of Manners; Novel-in-Episodes
  - Themes: Social Satire; Identity; Modernization; Tradition and Modernity; Human Nature; Vanity; Intellectualism; Alienation; Individualism; Conformity; Class; Friendship; Observation; Irony; Humor; Cultural Criticism
  - Settings: Tokyo; Japan
  - Historical Periods: Meiji Era; Early 20th Century
  - Subjects: Japanese Literature; Meiji Japan; Japanese Society; Japanese Culture; Japanese Identity; Modernization; Westernization; Middle Class; Intellectual Life; Academic Life; Philosophy; Social Criticism; Cats in Literature; Anthropomorphism; Humor; Cats; Animal Narrators
  - Audiences: Adult; General Readers
- Verdict: **Manual correction required**
- Required corrections:
  - Move Genres: `Literary Fiction` -> Subgenres: `Literary Fiction`
  - Normalize Subgenres value `Humour` -> `Humor`
  - Remove duplicate Themes value `Modernization`; retain Subjects: `Modernization`
  - Remove duplicate Themes value `Humor`; retain Subjects: `Humor`
  - Move Themes: `Cultural Criticism` -> Subgenres: `Cultural Criticism`
  - Retain as Themes after removing misplaced values: Social Satire; Identity; Tradition and Modernity; Human Nature; Vanity; Intellectualism; Alienation; Individualism; Conformity; Class; Friendship; Observation; Irony
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  ...
  - Subgenres: Adventure Fiction; Historical Adventure; Literary Fiction; Epic Literature; Novella; Romantic Nationalism
  - Themes: Honor; Loyalty; Brotherhood; Family; Father-Son Relationships; Betrayal; Love; Duty; Sacrifice; Heroism; Courage; Faith; Freedom; War; Death; Glory; Identity; National Identity; Tradition; Revenge; Tragic Ending
  - Settings: Ukraine; Zaporizhian Sich; Dnieper River; Polish-Lithuanian Commonwealth; Ukrainian Steppe
  - Historical Periods: Early Modern; 16th Century; Polish-Lithuanian Commonwealth
  - Subjects: Russian Literature; Ukrainian Literature; Ukrainian History; Eastern European History; Cossacks; Zaporizhian Cossacks; Polish-Lithuanian Commonwealth; Polish History; Orthodox Christianity; Military History; Frontier Society; Oral Tradition; Folk Literature
  - Audiences: Adult; General Readers
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `Historical Fiction` -> Subgenres: `Historical Fiction`
  - Move Subgenres: `Novella` -> Forms: `Novella`
  - Retain as Themes after removing misplaced values: Honor; Loyalty; Brotherhood; Family; Father-Son Relationships; Betrayal; Love; Duty; Sacrifice; Heroism; Courage; Faith; Freedom; War; Death; Glory; Identity; National Identity; Tradition; Revenge; Tragic Ending
  - Populate Forms with: Novella
...
- Current populated fields:
  ...
  - Subgenres: Travel Writing; Nature Writing; Cultural History; Local History; Memoir
  - Themes: Landscape; Regional Identity; Celtic Identity; Myth and Reality; Tourism; Overtourism; Folklore; Sense of Place; Belonging; Home; Walking; Childhood Memories; Smugglers; Pirates; Coastal Life; Rural Life
  - Settings: Cornwall; England; Bodmin Moor; Tamar Valley; Penwith Peninsula
  - Historical Periods: Contemporary
  - Subjects: Cornish History; British History; Cultural History; Geography; Geology; Archaeology; Cornish Language; King Arthur; Tin Mining; Copper Mining; Fishing Communities; Literary History; Cornwall in Art and Literature
  - Audiences: Adult; General Readers
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Genres: `Travel` -> Subgenres: `Travel Writing`
  - Move Genres: `History` -> Subgenres: `History`
  - Move Subgenres: `Memoir` -> Forms: `Memoir`
  - Move Themes: `Folklore` -> Subgenres: `Folklore`
  - Retain as Themes after removing misplaced values: Landscape; Regional Identity; Celtic Identity; Myth and Reality; Tourism; Overtourism; Sense of Place; Belonging; Home; Walking; Childhood Memories; Smugglers; Pirates; Coastal Life; Rural Life
  - Populate Forms with: Memoir
...
- Current populated fields:
  ...
  - Subgenres: Dark Fantasy; Portal Fantasy; Supernatural Fiction; Adventure Fiction; Coming-of-Age
  - Themes: Coming of Age; Good versus Evil; Friendship; Loyalty; Courage; Sacrifice; Destiny; Identity; Family; Mother-Son Relationship; Dying Parent; Loss; Grief; Survival; Hope; Love; Redemption; Parallel Worlds; Quest; Power
  - Settings: The Territories; New Hampshire; New York City; Midwestern United States; Western United States; Pacific Coast; United States
  - Historical Periods: Contemporary; 1980s
  - Subjects: American Literature; Dark Fantasy; Parallel Universes; Multiverse; Hero's Journey; Quest Narrative; Magic; Magic Objects; Supernatural Creatures; Shape-Shifting; Monsters; Werewolves; Religious Fanaticism; Small-Town America; Medievalism; Hotels; Railroads
  - Audiences: Adult; Young Adult
- Verdict: **Manual correction required**
- Required corrections:
  - Keep only Genres: `Fantasy`; remove the mutually exclusive major labels Fiction
  - Move Genres: `Horror` -> Subgenres: `Horror`
  - Retain as Themes after removing misplaced values: Coming of Age; Good versus Evil; Friendship; Loyalty; Courage; Sacrifice; Destiny; Identity; Family; Mother-Son Relationship; Dying Parent; Loss; Grief; Survival; Hope; Love; Redemption; Parallel Worlds; Quest; Power
  - Forms is empty; verify whether the work is a Novel and populate the controlled Form field if so
- Manual review:
  - Confirm the proposed major Genre when the record contains more than one allowed major value
  - Confirm Form because the database does not store presentation mode for this record
...
- Current populated fields:
  ...
  - Themes: Artistic Vision; Cinema; Collaboration; Cultural Impact; Fear; Fear and Cinema; Filmmaking; Innovation; Nature versus Humanity; Storytelling; Suspense
  - Settings: Amity Island; Martha's Vineyard; Massachusetts; United States
  - Historical Periods: 1970s; Contemporary; New Hollywood
  - Subjects: Adaptation; American Cinema; Behind-the-Scenes Filmmaking; Blockbuster Cinema; Film Criticism; Film History; Film Production; History of Cinema; Hollywood History; Horror Cinema; Jaws; John Williams; Literary Adaptation; New Hollywood; Novel-to-Film Adaptation; Peter Benchley; Popular Culture; Richard Dreyfuss; Robert Shaw; Roy Scheider; Shark Films; Steven Spielberg; Thriller Films; Universal Pictures
  - Audiences: Adult; General Readers
- Verdict: **Mechanical corrections identified**
- Required corrections:
  - Move Themes: `Cinema` -> Subjects: `Cinema`
  - Move Themes: `Filmmaking` -> Subjects: `Filmmaking`
  - Retain as Themes after removing misplaced values: Artistic Vision; Collaboration; Cultural Impact; Fear; Fear and Cinema; Innovation; Nature versus Humanity; Storytelling; Suspense

## Completion Checklist

- [x] Audit all 445 books with at least one populated classification field
- [x] Exclude only books with no populated classification values
- [x] Preserve exact current values and database IDs in the report
- [x] Keep the audit read-only
- [ ] Apply the listed corrections only after manual confirmation of the flagged items
