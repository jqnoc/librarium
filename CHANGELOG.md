...
- Add book character annotations with Name, Description, Biography, required Importance, multi-select Role fields, translated badges, consistent annotation form styling, Book Details CRUD controls, manual drag-and-drop ordering, and Reading Session creation/editing from a character selector inside the dialog
