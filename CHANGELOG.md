...
- Reorganize the shared Add New Book and Edit Metadata forms with consistent field ordering, full-width row-based classification editing on the Book Details tab, a wider single-column classification editor dialog with shared-book counts, and aligned publication, contributor, source, and binding fields
