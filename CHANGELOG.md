...
### Added
- Add an unchecked-by-default per-book `Group by Day` option to organize reading-session rows under day separators while preserving individual session actions
