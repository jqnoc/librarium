...
- "Generate Infographic" button at the bottom of the Books Finished in YYYY page exports a PNG image with a dark-themed layout showing all book covers in an auto-fitted grid, the year, book count, average rating badge, and an accent separator; width and height are selectable in a modal before exporting
