...
- Book Details now groups taxonomy values into one Classification section and shows up to ten same-library Similar Works ranked by per-book inverse-cardinality weighted classification matches with normalized 0–100 similarity scores, with Settings controls for choosing which classification categories contribute
