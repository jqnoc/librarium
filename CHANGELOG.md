...
### Added
- Book Details Reading cards now offer a blurred in-app stopwatch for page-based readings in progress, with pause/resume controls, selected-reading session attachment when saved, and an X-only close action
