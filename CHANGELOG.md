...
- Book Details now groups taxonomy values into one Classification section and shows up to ten same-library Similar Works ranked by inverse-category-size weighted classification matches, with Settings controls for choosing which classification categories contribute
