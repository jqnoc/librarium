...
- Add a UTF-8 Markdown download for each book's thoughts, sorted by page while preserving Markdown headings inside each thought and rendering horizontal-rule separators correctly
