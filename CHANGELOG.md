...
- Sources now support place-specific metadata for physical stores and library sources, including address, permanent-closure status, and map coordinates; the Sources tab groups source types, shows richer place details, and plots coordinate-backed places on an interactive map
