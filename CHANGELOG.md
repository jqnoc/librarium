...
### Added
- Add unchecked-by-default per-book `Group by Day` and `Summarize by Day` options for organizing reading-session rows under day separators or daily aggregate rows while preserving individual session actions
