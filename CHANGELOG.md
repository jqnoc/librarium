...
### Added
- Book Details Reading cards now offer a blurred in-app stopwatch for page-based readings in progress, with book identity, live start and estimated end pages, pause/resume controls, direct Save Session timing, selected-reading attachment, and an X-only close action
