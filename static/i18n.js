...
(function () {
    ...
    var translations = {
        ...
        'auth.localOnlyTitle':   { en: 'Use local-only mode', es: 'Usar modo solo local' },
        'auth.localOnlyDescription': { en: 'Keep your library on this computer and continue without Dropbox synchronization.', es: 'Mantén tu biblioteca en este ordenador y continúa sin sincronización con Dropbox.' },
        'auth.localOnlyButton':  { en: 'Continue locally', es: 'Continuar localmente' },

        // ── Sync transparency ──────────────────────────────────────────
        'sync.title':            { en: 'Sync status', es: 'Estado de sincronización' },
        'sync.dropboxMode':      { en: 'Dropbox synchronization', es: 'Sincronización con Dropbox' },
        'sync.localOnly':        { en: 'Local-only mode', es: 'Modo solo local' },
        'sync.localOnlyShort':   { en: 'Local only', es: 'Solo local' },
        'sync.localOnlyDescription': { en: 'Dropbox synchronization is paused.', es: 'La sincronización con Dropbox está pausada.' },
        'sync.statusIdle':       { en: 'Ready', es: 'Listo' },
        'sync.statusLocal':      { en: 'Local only', es: 'Solo local' },
        'sync.statusSynced':     { en: 'Synced', es: 'Sincronizado' },
        'sync.statusSyncing':    { en: 'Syncing', es: 'Sincronizando' },
        'sync.statusConflict':   { en: 'Needs attention', es: 'Requiere atención' },
        'sync.statusError':      { en: 'Sync error', es: 'Error de sincronización' },
        'sync.downloading':      { en: 'Downloading...', es: 'Descargando...' },
        'sync.uploading':        { en: 'Uploading...', es: 'Subiendo...' },
        'sync.lastSuccessful':   { en: 'Last successful sync', es: 'Última sincronización correcta' },
        'sync.never':            { en: 'Never', es: 'Nunca' },
        'sync.currentActivity':  { en: 'Current activity', es: 'Actividad actual' },
        'sync.idle':             { en: 'Idle', es: 'En espera' },
        'sync.syncing':          { en: 'Syncing...', es: 'Sincronizando...' },
        'sync.pendingUploads':   { en: 'Pending uploads', es: 'Cargas pendientes' },
        'sync.pendingDownloads': { en: 'Pending downloads', es: 'Descargas pendientes' },
        'sync.now':              { en: 'Sync now', es: 'Sincronizar ahora' },
        'sync.useLocalOnly':     { en: 'Use local-only mode', es: 'Usar modo solo local' },
        'sync.reconnect':        { en: 'Reconnect Dropbox', es: 'Volver a conectar Dropbox' },
        'sync.conflicts':        { en: 'Conflicts', es: 'Conflictos' },
        'sync.noConflicts':      { en: 'No conflicts', es: 'No hay conflictos' },
        'sync.conflictDetail':   { en: 'The local and Dropbox copies differ.', es: 'Las copias local y de Dropbox son diferentes.' },
        'sync.keepLocal':        { en: 'Keep local', es: 'Conservar local' },
        'sync.useRemote':        { en: 'Use Dropbox', es: 'Usar Dropbox' },
        'sync.errors':           { en: 'Recent errors', es: 'Errores recientes' },
        'sync.noErrors':         { en: 'No recent errors', es: 'No hay errores recientes' },
        'sync.activity':         { en: 'Sync activity', es: 'Actividad de sincronización' },
        'sync.noActivity':       { en: 'No sync activity yet.', es: 'Aún no hay actividad de sincronización.' },
        'sync.resolveFailed':    { en: 'Could not resolve conflict.', es: 'No se pudo resolver el conflicto.' },
        ...
        'book.editClassification': { en: 'Edit Classification', es: 'Editar clasificación' },
        ...
        'book.sectionsNav':     { en: 'Book detail sections', es: 'Secciones del libro' },
        'book.readingsTab':     { en: 'Readings',              es: 'Lecturas' },
        'book.ratingTab':       { en: 'Rating',                es: 'Valoración' },
        ...
        'book.annotationsTab':  { en: 'Annotations',            es: 'Anotaciones' },
        'book.quotesTab':       { en: 'Quotes',                 es: 'Citas' },
        'book.wordsTab':        { en: 'Words',                  es: 'Palabras' },
        'book.editionsTab':     { en: 'Editions',               es: 'Ediciones' },
        'book.noClassification': { en: 'No classification yet.', es: 'Aún no hay clasificación.' },
        'book.noSimilarWorks':  { en: 'No similar works found.', es: 'No se encontraron obras similares.' },
        ...
        'book.finishPlanDescription': { en: 'Set an expected finish date and choose daily or weekly targets.', es: 'Establece una fecha prevista de finalización y elige objetivos diarios o semanales.' },
        'book.finishPlanMode': { en: 'Plan Cadence', es: 'Cadencia del Plan' },
        'book.finishPlanDaily': { en: 'Daily', es: 'Diario' },
        'book.finishPlanWeekly': { en: 'Weekly', es: 'Semanal' },
        'book.expectedFinishDate': { en: 'Expected Finish Date', es: 'Fecha Prevista de Finalización' },
        'book.saveFinishPlan': { en: 'Save Plan', es: 'Guardar Plan' },
        ...
        'book.finishPlanAlreadyReadThisWeek': { en: 'Already read this week', es: 'Ya leído esta semana' },
        'book.finishPlanFollowingDays': { en: 'Each following day', es: 'Cada día siguiente' },
        'book.finishPlanFollowingWeeks': { en: 'Each following week', es: 'Cada semana siguiente' },
        'book.finishPlanDays':  { en: 'days',                   es: 'días' },
        'book.finishPlanReadingWeeks': { en: 'Reading Weeks', es: 'Semanas de Lectura' },
        'book.finishPlanThisWeek': { en: 'This Week', es: 'Esta Semana' },
        'book.finishPlanWeekGoalReached': { en: "This week's reading goal reached! ✅", es: '¡Objetivo de lectura de esta semana alcanzado! ✅' },
        'book.finishPlanTimeReadThisWeek': { en: 'Time read this week', es: 'Tiempo leído esta semana' },
        'book.finishPlanWeeks': { en: 'weeks', es: 'semanas' },
        'book.startReadingSession': { en: 'Start Session', es: 'Iniciar sesión' },
        'book.resumeLastReadingSession': { en: 'Resume Last Session', es: 'Reanudar última sesión' },
        ...
        'book.readingSessionQuote': { en: 'Quote',                    es: 'Cita' },
        'book.readingSessionAddWord': { en: 'Add Word',              es: 'Añadir palabra' },
        'book.readingSessionWord': { en: 'Word',                      es: 'Palabra' },
        'book.readingSessionAddAnnotation': { en: 'Add Annotation',         es: 'Añadir anotación' },
        'book.readingSessionAnnotation': { en: 'Annotation',                 es: 'Anotación' },
        'book.readingSessionCharacters': { en: 'Characters',            es: 'Personajes' },
        ...
        'book.characterImportanceMinor': { en: 'Minor', es: 'Menor' },
        'book.characterImportanceBackground': { en: 'Background', es: 'De fondo' },
        'book.characterRole': { en: 'Role', es: 'Rol' },
        'book.characterRoleChoose': { en: 'Select one or more roles', es: 'Selecciona uno o más roles' },
        'book.characterRoleRequired': { en: 'At least one role is required.', es: 'Es obligatorio seleccionar al menos un rol.' },
        'book.characterRoleProtagonist': { en: 'Protagonist', es: 'Protagonista' },
        'book.characterRoleAntagonist': { en: 'Antagonist', es: 'Antagonista' },
        'book.characterRoleNarrator': { en: 'Narrator', es: 'Narrador' },
        'book.characterRoleMentor': { en: 'Mentor', es: 'Mentor' },
        'book.characterRoleRival': { en: 'Rival', es: 'Rival' },
        'book.characterRoleLoveInterest': { en: 'Love interest', es: 'Interés romántico' },
        'book.characterRoleFoil': { en: 'Foil', es: 'Contrapunto' },
        'book.characterRoleOther': { en: 'Other', es: 'Otro' },
        'book.readingSessionEditingLastAnnotation': { en: 'Editing the last saved annotation', es: 'Editando la última anotación guardada' },
        'book.readingSessionWritingNewAnnotation': { en: 'Writing a new annotation', es: 'Escribiendo una nueva anotación' },
        'book.readingSessionNewAnnotation': { en: 'New Annotation',         es: 'Nueva anotación' },
        'book.readingSessionEditLastAnnotation': { en: 'Edit Last Annotation', es: 'Editar última anotación' },
        ...
        'book.annotationRequired': { en: 'Annotation text is required.',  es: 'El texto de la anotación es obligatorio.' },
        ...
        'book.colPace':         { en: 'Pace',                 es: 'Ritmo' },
        'book.paceFaster':      { en: 'Faster than average',  es: 'Más rápido que la media' },
        'book.paceSlower':      { en: 'Slower than average',  es: 'Más lento que la media' },
        ...
        'bookForm.editionHint':     { en: 'Work-level fields (author, original work info) are pre-filled. Edition-level fields (language, publisher, pages, cover) are for this specific edition.', es: 'Los campos a nivel de obra (autor e información original) están pre-rellenados. Los campos a nivel de edición (idioma, editorial, páginas y portada) son para esta edición específica.' },
        ...
        // ── Annotation-related strings ─────────────────────────────────
        'book.quotes':              { en: 'Quotes',                es: 'Citas' },
        'book.annotations':        { en: 'Annotations',           es: 'Anotaciones' },
        'book.exportAnnotationsMarkdown': { en: 'Download Markdown',   es: 'Descargar Markdown' },
        'book.exportAnnotationsMarkdownTitle': { en: 'Download annotations as Markdown', es: 'Descargar anotaciones como Markdown' },
        'book.exportClassificationMarkdown': { en: 'Download Markdown', es: 'Descargar Markdown' },
        'book.exportClassificationMarkdownTitle': { en: 'Download classification as Markdown', es: 'Descargar clasificación como Markdown' },
        'book.words':               { en: 'Words',                 es: 'Palabras' },
        'book.characters':          { en: 'Characters',             es: 'Personajes' },
        'book.exportCharactersMarkdown': { en: 'Download Markdown', es: 'Descargar Markdown' },
        'book.exportCharactersMarkdownTitle': { en: 'Download characters as Markdown', es: 'Descargar personajes como Markdown' },
        'book.noQuotes':            { en: 'No quotes yet.',        es: 'Aún no hay citas.' },
        'book.noAnnotations':       { en: 'No annotations yet.',   es: 'Aún no hay anotaciones.' },
        'book.annotationDate':      { en: 'Date',                  es: 'Fecha' },
        'book.sortAnnotationsBy':   { en: 'Sort by',                es: 'Ordenar por' },
        'book.sortAnnotationsPage': { en: 'Page',                  es: 'Página' },
        'book.sortAnnotationsDate': { en: 'Date',                  es: 'Fecha' },
        'book.sortAnnotationsOrder': { en: 'Order',                es: 'Orden' },
        'book.sortAnnotationsAscending': { en: 'Ascending',        es: 'Ascendente' },
        'book.sortAnnotationsDescending': { en: 'Descending',      es: 'Descendente' },
        'book.noWords':             { en: 'No words yet.',         es: 'Aún no hay palabras.' },
        'book.noCharacters':        { en: 'No characters yet.',   es: 'Aún no hay personajes.' },
        'book.deleteCharacterConfirm': { en: 'Delete this character?', es: '¿Eliminar este personaje?' },
        'book.addQuoteBtn':         { en: '+ Add Quote',           es: '+ Añadir Cita' },
        'book.addAnnotationBtn':    { en: '+ Add Annotation',      es: '+ Añadir Anotación' },
        'book.addWordBtn':          { en: '+ Add Word',            es: '+ Añadir Palabra' },
        'book.addCharacterBtn':     { en: '+ Add Character',        es: '+ Añadir Personaje' },
        'book.characterName':       { en: 'Name',                  es: 'Nombre' },
        'book.characterNamePlaceholder': { en: 'Character name',    es: 'Nombre del personaje' },
        'book.characterDescription': { en: 'Description',           es: 'Descripción' },
        'book.characterDescriptionPlaceholder': { en: 'Short description', es: 'Descripción breve' },
        ...
        'book.annotationTextPlaceholder': { en: 'Your annotation...', es: 'Tu anotación...' },
        ...
        'bookForm.booklyImportDesc':  { en: 'Upload a Bookly summary PDF to import quotes, annotations, and words.', es: 'Sube un PDF de resumen de Bookly para importar citas, anotaciones y palabras.' },
        'bookForm.booklyClearExisting': { en: 'Remove existing quotes, annotations & words before importing', es: 'Eliminar citas, anotaciones y palabras existentes antes de importar' },
