...
(function () {
    ...
    var translations = {
        ...
        'bookForm.editionHint':     { en: 'Work-level fields (author, original work info, genre) are pre-filled. Edition-level fields (language, publisher, pages, cover) are for this specific edition.', es: 'Los campos a nivel de obra (autor, información original, género) están pre-rellenados. Los campos a nivel de edición (idioma, editorial, páginas, portada) son para esta edición específica.' },
