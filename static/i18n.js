...
(function () {
    ...
    var translations = {
        ...
        'bookForm.editionHint':     { en: 'Work-level fields (author, original work info, genres, tags) are pre-filled. Edition-level fields (language, publisher, pages, cover) are for this specific edition.', es: 'Los campos a nivel de obra (autor, información original, géneros, etiquetas) están pre-rellenados. Los campos a nivel de edición (idioma, editorial, páginas, portada) son para esta edición específica.' },
        ...
        'dash.timeRead':            { en: 'Time read',               es: 'Tiempo leído' },
        'dash.timeLeft':             { en: 'left',                   es: 'restantes' },
        'dash.timeLeftLabel':       { en: 'Time left',                es: 'Tiempo restante' },
