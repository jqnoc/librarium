...
(function () {
    ...
    var translations = {
        ...
        'book.readingInfographic.progressTimeline': { en: 'Progress Timeline', es: 'Línea de progreso' },
        'book.readingInfographic.noProgressData': { en: 'No progress data', es: 'Sin datos de progreso' },
        ...
        'bookForm.forms':           { en: 'Subgenres',           es: 'Subgéneros' },
        'bookForm.genreDescription': { en: "The broad category that defines the book's overall type.", es: 'La categoría amplia que define el tipo general del libro.' },
        'bookForm.subgenreDescription': { en: 'A more specific classification that further describes the book.', es: 'Una clasificación más específica que describe con mayor detalle el libro.' },
        'bookForm.themesDescription': { en: 'The central ideas, emotions, or issues explored throughout the book.', es: 'Las ideas, emociones o cuestiones centrales que se exploran a lo largo del libro.' },
        'bookForm.settingDescription': { en: 'The main locations or environments in which the story unfolds or the subject is situated.', es: 'Los lugares o entornos principales en los que se desarrolla la historia o se sitúa el tema.' },
        'bookForm.historicalPeriodDescription': { en: "The historical era or chronological period covered by the story or the book's subject.", es: 'La época histórica o el período cronológico que abarca la historia o el tema del libro.' },
        'bookForm.subjectDescription': { en: 'The principal people, places, events, disciplines, or topics discussed in the book.', es: 'Las personas, lugares, acontecimientos, disciplinas o temas principales que se tratan en el libro.' },
        'bookForm.audienceDescription': { en: 'The readers for whom the book is primarily intended.', es: 'Los lectores a los que va dirigido principalmente el libro.' },
        ...
        'dash.formCloud':           { en: 'Subgenre Cloud',        es: 'Nube de Subgéneros' },
        ...
        'dash.noForms':             { en: 'books without subgenres', es: 'libros sin subgéneros' },
